...
arrText = ["Ку", "Да я тут", "Что нада",
           "Напишите мне привет хотя-б", "Я тебя не понимаю. Напиши /help."]
...
def send_addfriend(message):
    if message.text == "Познакомимся":
        ...
        url_button = types.InlineKeyboardButton(text="Перейти на Яндекс", url="https://yandex.by")
